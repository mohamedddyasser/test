...
class AccountBatchPayment(models.Model):
    ...
    @api.depends('payment_ids.move_id.is_move_sent', 'payment_ids.is_matched', 'cancel_check',
                 'under_approval_check', 'confirm_check')
        ...
        for batch in self:
            ...
            if self.under_approval_check:
                ...
                if batch.confirm_check and batch.state == 'under_approval':
                    ...
                    if batch.payment_ids and all(pay.is_move_sent for pay in batch.payment_ids) and self.confirm_check:
                        batch.state = 'sent'
