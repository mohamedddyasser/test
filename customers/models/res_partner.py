...
class ResPartner(models.Model):
    ...
    abra_bank_account_id = fields.Many2one(comodel_name='res.partner.bank', string="Abra Bank Account")
    ...
    def customer_approval_unarchive(self):
        if self.activity_type_id.id == self.env.ref("customers.approve_customer_activity").id:
