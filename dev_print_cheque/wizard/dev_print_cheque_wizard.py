...
class dev_print_cheque_wizard(models.TransientModel):
    ...
    def _get_check_formate(self):
        ...
        formate_id = self.env["cheque.setting"].search(
            [("set_default", "=", True), ("company_id", "=", company_id)], limit=1
        )
    ...
    cheque_formate_id = fields.Many2one(
        "cheque.setting", "Cheque Formate", default=_get_check_formate, required="1"
    )
    ...
    def print_cheque(self):
        ...
        return self.env.ref(
            "dev_print_cheque.action_report_print_cheque"
